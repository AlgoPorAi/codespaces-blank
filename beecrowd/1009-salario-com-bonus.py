...
'''
# Objetivo: Ler nome, salário fixo (float), total de vendas; calcular e exibir o total a receber

# --- ANÁLISE (LIAC) ---
# Entrada: nome (texto), salário fixo (float), total de vendas efetuadas (float)
# Processamento: vendas * 0.15 - total = salário fixo + comissão
...
# O vendedor ganha 15% de comição sobre o total de vendas
c = v * 0.15

# Total a receber = salário fixo + comissão
st = s + c

#  :.2f dentro da f-strinfg - formata o número com exatamente 2 casas decimais
