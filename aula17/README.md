...
​
## 🎯 Autoavaliação
Conceito pretendido: B ou C
​
Justificativa: consegui adicionar o lagarto e o spock, mas não consegui realizar o jogo terminar com 3 pontos:
- O jogo funciona ............: ppt.py, linhas 7 a 60
- Trabalho com texto .........: ppt.py, linha 43  (.lower().strip(), in, ==)
- Documentação e Git .........: este README + commits no GitHub
- Extensão/originalidade .....: ppt.py, linha 34  (o que eu criei — níveis B/A)
​
